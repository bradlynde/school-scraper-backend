...
function getAuthApiUrl(): string {
  let url = process.env.NEXT_PUBLIC_AUTH_API_URL || process.env.NEXT_PUBLIC_SCHOOL_API_URL || process.env.NEXT_PUBLIC_API_URL || "https://school-scraper-backend-production.up.railway.app";
  url = url.replace(/\/+$/, "");
