...
const Sidebar = ({ activeTab, onTabChange, onRunSelect }: SidebarProps) => {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 shadow-sm z-50 flex flex-col">
      {/* Logo Section */}
      ...
      <div className="flex-1 overflow-y-auto">
        <button
          ...
          className="w-full px-4 py-3 flex items-center justify-between text-gray-700 hover:bg-gray-50 border-b border-gray-200"
        >
        ...
        {showHistory && (
          <div className="p-2 space-y-2">
            {loading ? (
              ...
              <div className="text-center text-gray-500 py-4 text-sm">No runs yet</div>
            ) : (
              runs.map((run) => (
                <div
                  key={run.run_id}
