...
if __name__ == "__main__":
    ...
    test_contacts = [
        Contact(first_name="John", last_name="Doe", email="john@example.com", church_name="Test Church"),
        Contact(first_name="Jane", last_name="Smith", email=None, church_name="Test Church"),
        Contact(first_name="Bob", last_name="Jones", email="bob@example.com", church_name="Test Church"),
    ]
