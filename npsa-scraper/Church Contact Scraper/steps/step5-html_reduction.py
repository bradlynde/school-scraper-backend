...
class HTMLReducer:
    ...
    def __init__(self):
        ...
        self.title_keywords = [
            ...
            # Church-specific
            'pastor', 'minister', 'priest', 'rector', 'vicar', 'elder', 'deacon',
            'bishop', 'clergy', 'emeritus', 'reverend',
            # Church title modifiers (e.g. "Senior Pastor", "Executive Pastor")
            'senior pastor', 'lead pastor', 'executive pastor', 'associate pastor',
            'campus pastor', 'teaching pastor', 'care pastor', 'youth pastor',
            'pastor emeritus', 'pastor emeriti',
        ]
        
        # Keywords that indicate contact/staff sections
        self.contact_section_keywords = [
            'staff', 'faculty', 'team', 'leadership', 'administration', 'ministry',
            'directory', 'contact', 'people', 'member', 'employee',
            # Church-specific section names
            'elders', 'deacons', 'pastors', 'clergy', 'emeriti', 'lead team',
            'our team', 'our staff', 'staff & elders', 'staff and elders',
        ]
