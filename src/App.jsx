      ...
      {reviewMode && (
        <div style={{flex:1,display:"flex",flexDirection:"column",background:"#dde0e6"}}>
          ...
          <div style={{background:"#1a4a6e",color:"#fff",padding:"12px 32px",display:"flex",alignItems:"center",gap:16,flexShrink:0,boxShadow:"0 2px 8px rgba(0,0,0,0.2)"}}>
            ...
            <span style={{opacity:0.75,fontSize:12}}>Click anywhere in the document to edit. Changes apply to this copy only.</span>
              ...
              <button onClick={()=>{
                if(reviewIframeRef.current){
                  ...
                  if(doc){
                    ...
                    const printHtml = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Engagement Letter - ${form.clientName||"Client"}</title><link rel="preconnect" href="https://fonts.googleapis.com"><link href="https://fonts.googleapis.com/css2?family=Ms+Madi&display=swap" rel="stylesheet"><style>body{font-family:Georgia,serif;font-size:11.5pt;line-height:1.7;color:#1a1a1a;margin:0;padding:0}.page{padding:72pt;max-width:8.5in;margin:0 auto}div,span{font-family:Georgia,serif;font-size:11pt;line-height:1.75;box-sizing:border-box}@media print{@page{margin:72pt;size:letter}body{margin:0}}</style></head><body><div class="page">${bodyContent}</div><script>document.fonts.ready.then(function(){window.print();});<\/script></body></html>`;
                    const win = window.open("","_blank");
                    if(win){win.document.write(printHtml);win.document.close();}
                  }
                }
              }} style={{background:"#2e7d32",color:"#fff",border:"none",padding:"7px 16px",borderRadius:5,cursor:"pointer",fontSize:12,fontWeight:600}}>Print / Save as PDF</button>
